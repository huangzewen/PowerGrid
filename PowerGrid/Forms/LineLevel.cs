...
{
    public partial class LineLevel : Form
    {
        ...
        {
            InitializeComponent();
            this.LineLeveldataGridView.AutoGenerateColumns = true;
            this.LineLeveldataGridView.DataBindingComplete += new DataGridViewBindingCompleteEventHandler(this.DataBindingComplete);

            this.AutoSizeColumn(this.LineLeveldataGridView);
        ...
        {
            string sqlStr = @"SELECT b.SubStationLevel, a.LineLevel FROM `LineLevel` AS a, `SubStationLevel` AS b WHERE a.SubStationLevelId = b.Id;";
            ...
            dt.Columns["LineLevel"].ColumnName = "线路等级";
            return dt;
        }
        #endregion
        ...
        private void adapter_PageChanged(object sender, PageChangedEventArgs e)
        {
            ...
            this.LineLeveldataGridView.DataSource = dataTable.AsDataView();                  // Display the dats in the DataGridView
        ...
        {
            foreach (DataGridViewRow dataGridViewRow in this.LineLeveldataGridView.Rows)
            {
            ...
            this.LineLeveldataGridView.AutoResizeRowHeadersWidth(DataGridViewRowHeadersWidthSizeMode.AutoSizeToAllHeaders);
        }
