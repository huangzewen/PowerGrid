...
namespace PowerGrid.Forms
{
    public partial class Line : Form
    {
        ...
        {
            InitializeComponent();
            this.LinedataGridView.AutoGenerateColumns = true;
            this.LinedataGridView.DataBindingComplete += new DataGridViewBindingCompleteEventHandler(this.DataBindingComplete);

            this.AutoSizeColumn(this.LinedataGridView);
        ...
        {
            string sqlStr = @"SELECT b.SubStationName, a.Line FROM `Line` AS a, `SubStation` AS b WHERE a.SubStationId = b.Id;";
            ...
            dt.Columns["Line"].ColumnName = "线路名称";
            return dt;
        }
        #endregion
        ...
        private void adapter_PageChanged(object sender, PageChangedEventArgs e)
        {
            ...
            this.LinedataGridView.DataSource = dataTable.AsDataView();                  // Display the dats in the DataGridView
        ...
        {
            foreach (DataGridViewRow dataGridViewRow in this.LinedataGridView.Rows)
            {
            ...
            this.LinedataGridView.AutoResizeRowHeadersWidth(DataGridViewRowHeadersWidthSizeMode.AutoSizeToAllHeaders);
        }
