...
{
    public partial class MainTformer : Form
    {
        ...
        {
            InitializeComponent();
            this.MainTformerdataGridView.AutoGenerateColumns = true;
            this.MainTformerdataGridView.DataBindingComplete += new DataGridViewBindingCompleteEventHandler(this.DataBindingComplete);

            this.AutoSizeColumn(this.MainTformerdataGridView);
        ...
        {
            string sqlStr = @"SELECT b.SubStationName, a.MainTformer FROM `MainTformer` AS a, `SubStation` AS b WHERE a.SubStationId = b.Id;";
            ...
            dt.Columns["MainTformer"].ColumnName = "主变";
            return dt;
        }
        #endregion
        ...
        {
            foreach (DataGridViewRow dataGridViewRow in this.MainTformerdataGridView.Rows)
            {
            ...
            this.MainTformerdataGridView.AutoResizeRowHeadersWidth(DataGridViewRowHeadersWidthSizeMode.AutoSizeToAllHeaders);
        }
